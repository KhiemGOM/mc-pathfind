...
public final class RouteState {
    // Must be declared before INSTANCE: the constructor reads it, and statics initialize in order.
    ...
    public static final class Route {
        ...
        public final long animStartNanos; // System.nanoTime() when the reveal animation began; 0 = draw fully

        public Route(double[][] points, Action[] actions, Status status, String message) {
            this(points, actions, status, message, 0L);
        }

        public Route(double[][] points, Action[] actions, Status status, String message, long animStartNanos) {
            this.points = points;
